...
from programmingalpha.DocSearchEngine.entity.answer import Answer
from programmingalpha.DocSearchEngine.entity.post import Post
from programmingalpha.DocSearchEngine.entity.question import Question
