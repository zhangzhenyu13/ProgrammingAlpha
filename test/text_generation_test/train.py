...
'''single train'''
from programmingalpha.models.openNMT_utils.train_single import main as single_main
...
def _get_parser():
    ...
    group.add('--pretrained_encoder', '-pretrained_encoder', default="bert", type=str,
