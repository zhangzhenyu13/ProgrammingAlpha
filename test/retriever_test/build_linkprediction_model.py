...
def main():
    ...
    if task_name not in processors:
        raise ValueError("Task not found: {}, ({})".format(task_name,processors.keys()))

    processor = processors[task_name](dataSource)
    num_labels = num_labels_task[task_name]
    labelMap = LinkSearcher.label_map
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if (1+step)%args.eval_step_size==0:
                    ...
                    if eval_acc>best_eval_acc:
                        ...
                        '''
                        sranker=LinkSearcher(args.output_dir, args.model_name)
                        s_outs=sranker.getRelationProbability(DataLoader(eval_data, sampler=eval_sampler, batch_size=args.eval_batch_size))
